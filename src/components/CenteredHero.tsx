// Enhanced by AI on 2025-08-16T17:25:07.510Z
// Section: hero
// Category: hero
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary">
              ...
              New Professional Shoe Collection
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Discover our curated collection of high-quality, stylish professional shoes designed to
              elevate your look and comfort in the office. Upgrade your wardrobe with the perfect
              footwear for the modern workplace.
            </p>
